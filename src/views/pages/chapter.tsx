    ...
    return (
        ...
        <BaseBody className="!bg-[#000]" disableAds={chapter.manga.isAdult}>
            <div class="container p-0">
                <div class="mx-auto  flex w-full max-w-[1000px] flex-wrap items-center justify-center">
                    ...
                    <div class="w-full border bg-[#f6f7f8]">
                        ...
                        >
                            ...
                            <button
                                class="prev-chapter flex w-10 flex-nowrap items-center justify-center gap-2 rounded-s-md bg-[#d9534f] p-2 leading-normal text-white">
                                <svg
                                    fill="currentColor"
                                    class="h-3 w-3"
                                    viewBox="0 0 512 512"
                            ...
                            <button
                                class="next-chapter flex w-10 flex-nowrap items-center justify-center gap-2 rounded-e-md bg-[#d9534f] p-2 leading-normal text-white">
                                <svg
                                    fill="currentColor"
                                    class="h-3 w-3"
                                    xmlns="http://www.w3.org/2000/svg"
                ...
                <div
                    class="chapter-nav mx-auto my-10 flex w-full max-w-[1000px] select-none flex-wrap items-center justify-center gap-5">
