    ...
    return (
        <section class="carousel-trending relative">
            <div class="flex justify-between border-l-[5px] border-primary my-[10px] text-[20px] " style={{ lineHeight: '60px' }}>
                ...
                <div class="flex justify-between items-center gap-2 end-0">
                    <button class="carousel-button--prev border p-3 rounded-full shadow">
                        <svg class="w-6 h-6" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M13.293 6.293 7.586 12l5.707 5.707 1.414-1.414L10.414 12l4.293-4.293z"></path></svg>
                    </button>
                    <button class="carousel-button--next border p-3 rounded-full shadow">
                        <svg class="w-6 h-6" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M10.707 17.707 16.414 12l-5.707-5.707-1.414 1.414L13.586 12l-4.293 4.293z"></path></svg>
                    </button>
                </div>
                ...
                <div class="embla__container">
                    {mangas.map((manga, index) => (
                        <div class="embla__slide cursor-pointer">
                            <div class="relative pb-[133.33%] rounded-md overflow-hidden">
                            ...
                            <div class="flex flex-wrap mt-2 cursor-pointer">
                                <a href={mangaUrl(manga)} class="w-full">
                                    <h2 class="text-[16px] font-medium w-full hover:text-primary transition-colors duration-300 mb-2 two-lines">{manga.title}</h2>
                                </a>

                                {manga.chapters?.length > 0 && (
                                    <a class="flex items-center gap-2 between w-full text-[13px] text-gray-800 visited:text-gray-800" href={`/`}>
                                        ...
                                        <span class="w-5/6 truncate text-right text-gray-800">{
                                            new Date(manga.chapters[0].updatedAt).toLocaleDateString('ja-JP', {
                                                year: 'numeric',
                                                month: 'short',
                                                day: 'numeric'
                                            })
