import { mangaUrl } from "@@/src/services/url";
    ...
    return (
        <>
            ...
            <ul class="grid grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3 md:gap-4 mt-6">
                {mangas.map((manga) => (
                    <li>
                        <div class="relative pb-[70%] rounded-md overflow-hidden">
                            ...
                            <div class="gap-2 h-7 bottom-0 w-full absolute bg-black bg-opacity-70 flex no-wrap items-center justify-start px-2 text-xs text-white font-medium">
                                <span class="flex items-center gap-0.5">
                                    ...
                                    <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" class=" h-3 w-3" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M1.18164 12C2.12215 6.87976 6.60812 3 12.0003 3C17.3924 3 21.8784 6.87976 22.8189 12C21.8784 17.1202 17.3924 21 12.0003 21C6.60812 21 2.12215 17.1202 1.18164 12ZM12.0003 17C14.7617 17 17.0003 14.7614 17.0003 12C17.0003 9.23858 14.7617 7 12.0003 7C9.23884 7 7.00026 9.23858 7.00026 12C7.00026 14.7614 9.23884 17 12.0003 17ZM12.0003 15C10.3434 15 9.00026 13.6569 9.00026 12C9.00026 10.3431 10.3434 9 12.0003 9C13.6571 9 15.0003 10.3431 15.0003 12C15.0003 13.6569 13.6571 15 12.0003 15Z"></path></svg></span><span class="flex items-center gap-0.5"><span>0</span><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" class=" h-3 w-3" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M5 2H19C19.5523 2 20 2.44772 20 3V22.1433C20 22.4194 19.7761 22.6434 19.5 22.6434C19.4061 22.6434 19.314 22.6168 19.2344 22.5669L12 18.0313L4.76559 22.5669C4.53163 22.7136 4.22306 22.6429 4.07637 22.4089C4.02647 22.3293 4 22.2373 4 22.1433V3C4 2.44772 4.44772 2 5 2Z" />
                                        </svg>
                                </span>
                            </div>
                        </div>
