...
const HomeUpdate = ({ headingText, mangas }: HomeUpdateProps): JSX.Element => {
  return (
    <>
      <div
        class="border-primary my-[10px] flex flex-nowrap items-center gap-2 border-l-[5px] text-[20px] "
